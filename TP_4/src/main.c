...
int main(void)
{
	...
	startTesting(6);  // ll_get 100%   DEBERIA CONSIDERAR EL index <= ll_len?
	startTesting(7);  // ll_set	 100%    //deberia llamar al getElement o al getNode DEBERIA CONSIDERAR EL index <= ll_len? entiendo que si porque contiene un elemento y su nextNode apunta a NULL
